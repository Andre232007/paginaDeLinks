...
profileData.socialLinks.forEach((socialLink) => {
  ...
  if (socialLink.inlineSvg && socialLink.svg) {
    // Se for um SVG inline, injeta diretamente
   a.innerHTML = `<span class="svg-icon">${socialLink.svg}</span>`;

  } else {
    // Se for imagem comum, cria um <img>
